...
export const JOB_CHANGE_GATES = [
  {
    ...
    steps: [
      ...
      { day: 2, title: 'Body Foundation', description: '50 push-ups + 50 squats + shadow boxing 5 min', pillar: 'body', xp: 100 },
      { day: 3, title: 'AI First Step', description: 'Write your first Python script or study one AI concept for 1 hour', pillar: 'money', xp: 100 },
      ...
      { day: 6, title: 'Code Discipline', description: 'Study one AI/ML concept + no impulse spending', pillar: 'money', xp: 120 },
      { day: 7, title: "BOSS: The Apprentice's Awakening", description: 'Complete all daily quests + 1-hour deep work on AI project (first real system)', pillar: 'all', xp: 200 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 2, title: 'Warrior Body', description: '75 push-ups + 75 squats + 30 min jog + combat stance drill', pillar: 'body', xp: 150 },
      ...
      { day: 5, title: 'Endurance Test', description: '200 bodyweight reps + 5K run + heavy bag work', pillar: 'body', xp: 180 },
      { day: 6, title: 'Portfolio Review', description: 'Audit all investments for Shariah compliance + review AI project code', pillar: 'money', xp: 180 },
      { day: 7, title: "BOSS: The Builder's Reckoning", description: 'All quests + ship one AI feature + teach someone one AI skill', pillar: 'all', xp: 300 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 2, title: 'Guardian\'s Strength', description: '100 push-ups + 100 squats + 20 pull-ups + sparring drill', pillar: 'body', xp: 200 },
      ...
      { day: 5, title: 'Combat Readiness', description: 'Spar or drill martial arts for 30 min', pillar: 'body', xp: 250 },
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 2, title: 'Strategist\'s Body', description: '5x5 heavy strength + 10K run + combat sparring', pillar: 'body', xp: 300 },
      ...
      { day: 5, title: 'Elite Fitness', description: 'Marathon or equivalent endurance feat', pillar: 'body', xp: 350 },
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 2, title: 'Khalifa\'s Apex', description: 'Competitive physical feat in top 5%', pillar: 'body', xp: 500 },
      ...
      { day: 5, title: 'Physical Mastery', description: '1-year elite fitness without breaks', pillar: 'body', xp: 600 },
