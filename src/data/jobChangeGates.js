...
export const JOB_CHANGE_GATES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 4, title: 'Rawatib & Tafseer Study', description: 'Pray all 12 rawatib sunnah prayers + study Tafseer of 5 verses in private', pillar: 'deen', xp: 250 },
      ...
      { day: 7, title: "BOSS: The Guardian's Oath", description: 'All quests + 1 hour deep study of Sahaba biographies and character', pillar: 'all', xp: 400 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 7, title: "BOSS: The Strategist's War", description: 'All quests + 1.5 hours deep study on Islamic history and caliphate governance', pillar: 'all', xp: 600 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 4, title: 'Tafseer & Quran Mastery', description: 'Recite 3 Juz + study Tafseer for 2 hours in private', pillar: 'deen', xp: 600 },
