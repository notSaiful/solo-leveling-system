  ...
  pillars: [
    {
      ...
      tags: ['tauheed', 'quran', 'salah', 'seerah', 'sunnah', 'akhlaq', 'dawah', 'knowledge', 'dhikr', 'adhkar', 'hadith', 'hifz', 'dua', 'fasting', 'tahajjud'],
    },
    {
      id: 'wealth',
      ...
      tags: ['wealth', 'income', 'business', 'investing', 'halal', 'zakat', 'sadaqah', 'charity', 'frugality', 'saving', 'budget', 'portfolio', 'fund', 'ummah'],
    },
    {
      id: 'readiness',
      label: 'Physical Power Readiness',
      duty: 'Build physical strength, endurance, conditioning, mobility, restraint, and lawful preparedness to serve and protect without oppression.',
      tags: ['physical', 'strength', 'power', 'endurance', 'conditioning', 'mobility', 'discipline', 'health', 'body', 'safety', 'first aid', 'restraint', 'ruck', 'run', 'sprint'],
    },
    {
      id: 'service',
      label: 'Ummah Service',
      duty: 'Educate, uplift, mentor, fund relief, advocate lawfully, and improve Muslim livelihoods.',
      tags: ['ummah', 'service', 'relief', 'mentor', 'mentorship', 'teach', 'teaching', 'community', 'charity', 'advocacy', 'education', 'impact', 'counsel', 'volunteer'],
    },
    {
      id: 'family',
